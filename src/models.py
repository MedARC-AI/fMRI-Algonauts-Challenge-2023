...
class Clipper(torch.nn.Module):
    def __init__(self, clip_variant, clamp_embs=False, norm_embs=False,
        ...
        preproc = transforms.Compose([
            transforms.Resize(size=self.clip_size[0], interpolation=transforms.InterpolationMode.BICUBIC, antialias=False),
    ...
    def resize_image(self, image):
        ...
        return transforms.Resize(self.clip_size,antialias=False)(image.to(self.device))
